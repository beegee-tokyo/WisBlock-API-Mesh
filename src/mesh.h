...
void mesh_check_rx(uint8_t *payload, uint16_t size, int16_t rssi, int8_t snr);
...
extern volatile xQueueHandle mesh_msg_queue;
...
extern SemaphoreHandle_t access_node_list_sem;
